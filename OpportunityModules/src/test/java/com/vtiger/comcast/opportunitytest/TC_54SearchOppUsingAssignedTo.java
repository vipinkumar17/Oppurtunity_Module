...
public class TC_54SearchOppUsingAssignedTo extends BaseClass{
@Test(groups = {"smoketest"})
public void searchOppWithAssignedTo() throws Throwable
{
	...
	op.searchWithAssignedToStartsWith("Admini");
