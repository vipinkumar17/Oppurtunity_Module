...
public class TC_56SearchOppUsingAssignedToNotEquals extends BaseClass {
@Test(groups = {"smoketest"})
public void searchOppUsingAssignedToNotEquals() throws Throwable
{
	...
	op.searchWithAssignedToNotEquals("Administrator");
