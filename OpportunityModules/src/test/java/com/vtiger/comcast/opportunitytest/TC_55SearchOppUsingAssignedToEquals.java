...
public class TC_55SearchOppUsingAssignedToEquals extends BaseClass {
	@Test(groups = {"regresion"})
	public void searchOppWithAssignedToEquals() throws Throwable
	{
		...
		op.searchWithAssignedToEquals("Administrator");
